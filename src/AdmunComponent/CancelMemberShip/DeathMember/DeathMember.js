                              ...
                              <div className="input-group">
                                ...
                                <div className="form-line">
                                  ...
                                  <Form.Control
                                    ...
                                    {...register("shares", { required: "please enter भाग (शेअर्स)" })}
                                  />

                                </div>
                              </div>

                              <p style={{ color: "red" }}>{errors?.shares?.message}</p>

                            </div>


                            <div className="col-lg-6 col-md-6 col-sm-6 col-xs-6 myclass">
                              ...
                              <div className="input-group">
                                ...
                                <div className="form-line">
                                  ...
                                  <Form.Control
                                    ...
                                    {...register("masik", { required: "please enter मासिक ठेव" })}
                                  />

                                </div>
                              </div>
                              <p style={{ color: "red" }}>{errors?.masik?.message}</p>
                                ...
                                <div className="form-line">
                                  ...
                                  /> */}
                                   <Form.Control
                                    ...
                                    {...register("kalyan", { required: "Please Enter सभासद कल्याण निधी" })}
                                  />

                                </div>
                              </div>
                              <p style={{ color: "red" }}>{errors?.kalyan?.message}</p>
                                ...
                                <div className="form-line">
                                  ...
                                  /> */}
                                   <Form.Control
                                    ...
                                    {...register("payableA", { required: "please enter Payable Amount" })}
                                  />
                                </div>
                              </div>
                          <p style={{ color: "red" }}>{errors?.payableA?.message}</p>
                            ...
                            <div className="col-md-8">
                              ...
                              /> */}
                                  ...
                                  <Form.Control
                                    ...
                                    {...register("payTo", { required: "please enter Pay To" })}
                                  />
                                </div>
                              </div>
                          <p style={{ color: "red" }}>{errors?.payTo?.message}</p>

                            </div>

                            <div className="col-md-8">
                              <b>Nominee Name One</b>
                              <div className="input-group">
                                <span className="input-group-addon">
                                  <i className="material-icons">person</i>
                                </span>
                                <div className="form-line">
                                  <input
                                    type="text"
                                    className="form-control date"
                                    placeholder='Enter Nominee Name One'
                                  />
                                </div>
                              </div>
                            </div>
                              ...
                              <div className="input-group">
                                ...
                                <div className="form-line">
                                  <input
                                    type="text"
                                    className="form-control date"
                                    placeholder='Enter Nominee Name Two'
                                  />
                                </div>
                              </div>
                            </div>
