                      ...
                      <Form onSubmit={handleSubmit(Submit)}>
                        ...
                        <div className="col-md-8">
                          ...
                          <div className="input-group">
                            ...
                            <div className="form-line">
                            <Form.Group className="mb-3" controlId="loanamountcreditField">
                              <Form.Control
                                type="number"
                                className="form-control time24"
                                {...register("loanamountcredit",{required: "please enter Date"})}
                              />
                             </Form.Group>
                            </div>
                          </div>
                          <p style={{color:"red"}}>{errors?.loanamountcredit?.message}</p>
                          ...
                          <div className="input-group">
                            ...
                            <Form.Group className="mb-3" controlId="CreditLoanAmountField">
                              <Form.Control
                                ...
                                {...register("CreditLoanAmount",{required: "please enter Amount"})}
                              />
                               </Form.Group>
                            </div>
                          </div>
