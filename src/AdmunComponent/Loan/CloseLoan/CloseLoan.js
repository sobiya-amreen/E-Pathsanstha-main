                      ...
                      <Form onSubmit={handleSubmit(Submit)}>
                        ...
                        <div className="col-md-8">
                          ...
                          <div className="input-group">
                            ...
                            <div className="form-line">
                            <Form.Group className="mb-3" controlId="closeLoanField">
                              <Form.Control
                                type="date"
                                className="form-control date"
                                {...register("closeLoan",{required: "please enter Date"})}
                              />
                               </Form.Group>
                            </div>
                          </div>
                          <p style={{color:"red"}}>{errors?.closeLoan?.message}</p>
                        </div> 
                          ...
                          <div className="input-group">
                            ...
                            <Form.Group className="mb-3" controlId="paidAmountField">
                              <Form.Control
                                ...
                                {...register("paidAmount",{required: "please enter Paid Amount"})}
                              />
                               </Form.Group>
                            </div>
                          </div>
