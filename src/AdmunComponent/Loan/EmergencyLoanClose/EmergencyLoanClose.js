                      ...
                      <Form onSubmit={handleSubmit(Submit)}>
                        ...
                        <div className="col-md-8">
                          ...
                          <div className="input-group">
                            ...
                            <div className="form-line">
                            <Form.Group className="mb-3" controlId="emergencyLoanCloseField">
                              <Form.Control
                                type="date"
                                className="form-control date"
                                {...register("emergencyLoanClose",{required: "please enter Date"})}

                              />
                                 </Form.Group>
                            </div>
                          </div>
                          <p style={{color:"red"}}>{errors?.emergencyLoanClose?.message}</p>
                        </div> 
                        ...
                        <div className="col-md-8">
                          ...
                          <div className="input-group">
                            ...
                            <div className="form-line">
                            <Form.Group className="mb-3" controlId="paidAmountField">
                              <Form.Control
                                type="number"
                                className="form-control date"
                                placeholder="Enter Paid Amount"
                                {...register("paidAmount",{required: "please enter Amount"})}

                              />
                                 </Form.Group>
                            </div>
                          </div>
                          <p style={{color:"red"}}>{errors?.paidAmount?.message}</p>
                        </div> 
