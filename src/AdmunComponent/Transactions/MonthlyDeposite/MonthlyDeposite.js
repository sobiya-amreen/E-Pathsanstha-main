                      ...
                      <Form onSubmit={handleSubmit(Submit)}>
                        ...
                        <div className="col-md-8">
                          ...
                          <div className="input-group">
                            ...
                            <div className="form-line">
                            <Form.Group className="mb-3" controlId="monthlyDepositeField">
                              <Form.Control
                                type="number"
                                className="form-control date"
                                placeholder='Enter Monthly Deposit'
                                {...register("monthlyDeposite",{required: "please enter Monthly Deposit"})}
                              />
                                 </Form.Group>
                            </div>
                          </div>
                        ...
                        <div className="col-md-8">
                          ...
                          <div className="input-group">
                            ...
                            <div className="form-line">
                            <Form.Group className="mb-3" controlId="monthlyDepositeDateField">
                              <Form.Control
                                type="date"
                                className="form-control date"
                                {...register("monthlyDepositeDate",{required: "please enter Date"})}

                              />
                                 </Form.Group>
                            </div>
                          </div>
                          <p style={{color:"red"}}>{errors?.monthlyDepositeDate?.message}</p>
                        </div>
                          ...
                          <div className="input-group">
                            ...
                            <div className="form-line">
                              <input
                                type="number"
                                className="form-control date"
                                placeholder='Enter Total Monthly Deposit'
                              />
                            </div>
                          </div>
                        </div>
